...
export function ProfessionalForm({ initialData }) {
  const [currentStep, setCurrentStep] = useState(0);

  const { form, isLoadingCep, handleCepChange, onSubmit, isEditMode } =
    useCreateProfessional({ initialData });
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="mt-6 flex flex-col gap-3">
              {currentStep === steps.length - 1 ? (
                ...
                <Button type="button" onClick={processForm} className="w-full">
                  Continuar
                </Button>
              )}
